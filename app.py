...
# === Load model ===
model = joblib.load(r"C:\Users\HARIKA\OneDrive\Desktop\EV_charge\forecasting_ev_model.pkl")
...
# Image
st.image(r"C:\Users\HARIKA\OneDrive\Desktop\EV_charge\ev-car-factory.jpg", use_column_width=True)
...
@st.cache_data
def load_data():
    df = pd.read_csv(r"C:\Users\HARIKA\OneDrive\Desktop\EV_charge\preprocessed_ev_data.csv")
